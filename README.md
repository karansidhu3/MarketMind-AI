...
![Feed](marketmind/docs/screenshots/feed.png)

**Themes — ranked by weekly momentum**
![Themes](marketmind/docs/screenshots/themes.png)

**Portfolio — gap detection and alignment**
![Portfolio](marketmind/docs/screenshots/portfolio.png)

**Company investigation panel**
![Company Panel](marketmind/docs/screenshots/company-panel.png)
...
cd MarketMind-AI/marketmind  # project lives in the marketmind subdirectory
```
